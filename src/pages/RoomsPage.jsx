    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      <div className="bg-gradient-to-br from-primary-900 to-slate-900 py-14 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-slate-300 text-base">Search, filter, and book the perfect room for your study session.</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-xl font-heading font-semibold text-slate-700 dark:text-slate-200 mb-2">No rooms found</h3>
            <p className="text-slate-500 dark:text-slate-400">Try adjusting your search or filters.</p>
          </div>
        ) : (
          <>
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-5">{rooms.length} room{rooms.length !== 1 ? 's' : ''} found</p>
